...
compile_diag <- function(acc_path  = "./access_files",
  ...
  dataLoc <- bind_df_diffClass(olderLoc, dataLoc) # append newly compiled data onto older dataset
...
compile_dive <- function(acc_path  = "./access_files",
  ...
  dataDive <- bind_df_diffClass(olderDive, dataDive)
...
compile_ctd <- function(acc_path  = "./access_files",
  ...
  dataCTD <- bind_df_diffClass(olderCTD, dataCTD) # append newly compiled data onto older dataset
...
compile_haul <- function(acc_path  = "./access_files",
  ...
  dataHaul <- bind_df_diffClass(olderHaul, dataHaul) # append newly compiled data onto older dataset
...
compile_sum <- function(acc_path  = "./access_files",
  ...
  dataSum <- bind_df_diffClass(olderSum, dataSum) # append newly compiled data onto older dataset
